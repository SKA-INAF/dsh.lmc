...
void HdbConfigurationManager::write_SetAttributeName(Tango::WAttribute &attr)
{
	...
	INFO_STREAM<<"signame="<<signame<<endl;

	fix_tango_host(signame);
	INFO_STREAM<<"signame(after fixhost)="<<signame<<endl;


	//remove white spaces:
	signame.erase (std::remove (signame.begin(), signame.end(), ' '), signame.end());
	INFO_STREAM<<"signame(after erase)="<<signame<<endl;
	...
	INFO_STREAM<<"devname="<<devname<<", attname="<<attname<<endl;
 ...
 */
//--------------------------------------------------------
void HdbConfigurationManager::read_ArchiverContext(Tango::Attribute &attr)
{
	...
	for(archiver_map_t::iterator it = archiverMap.begin(); it != archiverMap.end(); it++)
	{
		...
		if(it->second.dp)
		{
			...
			{
				Tango::DeviceAttribute Dout;
				Dout = it->second.dp->read_attribute("Context");
				Dout >> context;
			}
			catch(Tango::DevFailed &e)
			{
 ...
 */
//--------------------------------------------------------
void HdbConfigurationManager::dummy_dyn_cmd(Tango::Command &command)
{
	DEBUG_STREAM << "HdbConfigurationManager::" << command.get_name() << "  - " << device_name << endl;
	/*----- PROTECTED REGION ID(HdbConfigurationManager::dummy_dyn_cmd) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	HdbConfigurationManager::dummy_dyn_cmd
}
//--------------------------------------------------------
/**
