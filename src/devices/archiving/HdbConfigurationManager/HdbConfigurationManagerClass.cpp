 ...
 */
//--------------------------------------------------------
HdbConfigurationManagerClass::HdbConfigurationManagerClass(string &s):LMCDevice_ns::LMCDeviceClass(s)
{
...
CORBA::Any *dummyDynCmdClass::execute(Tango::DeviceImpl *device, TANGO_UNUSED(const CORBA::Any &in_any))
{
	...
	((static_cast<HdbConfigurationManager *>(device))->dummy_dyn_cmd(*this));
	return new CORBA::Any();
}
...
void HdbConfigurationManagerClass::write_class_property()
{
	...
	str_desc.push_back("Hdb++ configuration manager");
