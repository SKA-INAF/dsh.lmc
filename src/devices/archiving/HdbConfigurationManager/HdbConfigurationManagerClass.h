...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<HdbConfigurationManager *>(dev))->is_dummyDynCmd_allowed(any);}
};
...
#ifdef _TG_WINDOWS_
class __declspec(dllexport)  HdbConfigurationManagerClass : public LMCDevice_ns::LMCDeviceClass
#else
class HdbConfigurationManagerClass : public LMCDevice_ns::LMCDeviceClass
#endif
{
