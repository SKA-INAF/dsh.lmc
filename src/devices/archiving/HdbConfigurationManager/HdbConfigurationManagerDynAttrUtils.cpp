/*----- PROTECTED REGION ID(HdbConfigurationManager::DynAttrUtils.cpp) ENABLED START -----*/
//=============================================================================
//
// file :        HdbConfigurationManagerDynAttrUtils.cpp
//
// description : Dynamic attributes utilities file for the HdbConfigurationManager class
//
...
/*----- PROTECTED REGION END -----*/	//	HdbConfigurationManager::DynAttrUtils.cpp
...
//	For compatibility reason, this file (HdbConfigurationManagerDynAttrUtils)
 ...
 */
//--------------------------------------------------------
void HdbConfigurationManager::add_dummyDynCmd_dynamic_command(string cmdname, bool device)
{
 ...
 */
//--------------------------------------------------------
void HdbConfigurationManager::remove_dummyDynCmd_dynamic_command(string cmdname)
{
