...
//
// description : C++ source for the HdbEventSubscriberClass.
//               A singleton class derived from DeviceClass.
//               It implements the command and attribute list
//               and all properties and methods required
//               by the HdbEventSubscriber once per process.
//
 ...
 */
//--------------------------------------------------------
HdbEventSubscriberClass::HdbEventSubscriberClass(string &s):LMCDevice_ns::LMCDeviceClass(s)
{
...
CORBA::Any *dummyDynCmdClass::execute(Tango::DeviceImpl *device, TANGO_UNUSED(const CORBA::Any &in_any))
{
	...
	((static_cast<HdbEventSubscriber *>(device))->dummy_dyn_cmd(*this));
	return new CORBA::Any();
}
...
void HdbEventSubscriberClass::set_default_property()
{
	...
	prop_desc = "Configuration for the library in this format:";
	prop_def  = "";
	vect_data.clear();
	if (prop_def.length()>0)
	{
...
void HdbEventSubscriberClass::write_class_property()
{
	...
	str_desc.push_back("NB: Adapted by Simone for SKA Dish LMC");
