...
//
// description : Include for the HdbEventSubscriber root class.
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<HdbEventSubscriber *>(dev))->is_dummyDynCmd_allowed(any);}
};
...
#ifdef _TG_WINDOWS_
class __declspec(dllexport)  HdbEventSubscriberClass : public LMCDevice_ns::LMCDeviceClass
#else
class HdbEventSubscriberClass : public LMCDevice_ns::LMCDeviceClass
#endif
{
	...
	public:
		...
		//	LibConfiguration:	Configuration for the library in this format:
