/*----- PROTECTED REGION ID(HdbEventSubscriber::DynAttrUtils.cpp) ENABLED START -----*/
//=============================================================================
//
// file :        HdbEventSubscriberDynAttrUtils.cpp
//
// description : Dynamic attributes utilities file for the HdbEventSubscriber class
//
...
/*----- PROTECTED REGION END -----*/	//	HdbEventSubscriber::DynAttrUtils.cpp
...
//	For compatibility reason, this file (HdbEventSubscriberDynAttrUtils)
 ...
 */
//--------------------------------------------------------
void HdbEventSubscriber::add_dummyDynCmd_dynamic_command(string cmdname, bool device)
{
 ...
 */
//--------------------------------------------------------
void HdbEventSubscriber::remove_dummyDynCmd_dynamic_command(string cmdname)
{
