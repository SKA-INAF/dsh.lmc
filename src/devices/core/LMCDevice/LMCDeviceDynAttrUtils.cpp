/*----- PROTECTED REGION ID(LMCDevice::DynAttrUtils.cpp) ENABLED START -----*/
//=============================================================================
//
// file :        LMCDeviceDynAttrUtils.cpp
//
// description : Dynamic attributes utilities file for the LMCDevice class
//
// project :     LMCDevice
//
...
/*----- PROTECTED REGION END -----*/	//	LMCDevice::DynAttrUtils.cpp
...
//	For compatibility reason, this file (LMCDeviceDynAttrUtils)
 ...
 */
//--------------------------------------------------------
void LMCDevice::add_dummyDynCmd_dynamic_command(string cmdname, bool device)
{
 ...
 */
//--------------------------------------------------------
void LMCDevice::remove_dummyDynCmd_dynamic_command(string cmdname)
{
