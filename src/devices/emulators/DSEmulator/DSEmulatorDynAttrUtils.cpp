/*----- PROTECTED REGION ID(DSEmulator::DynAttrUtils.cpp) ENABLED START -----*/
//=============================================================================
//
// file :        DSEmulatorDynAttrUtils.cpp
//
// description : Dynamic attributes utilities file for the DSEmulator class
//
// project :     DSEmulator
//
...
/*----- PROTECTED REGION END -----*/	//	DSEmulator::DynAttrUtils.cpp
...
//	For compatibility reason, this file (DSEmulatorDynAttrUtils)
 ...
 */
//--------------------------------------------------------
void DSEmulator::add_dummyDynCmd_dynamic_command(string cmdname, bool device)
{
 ...
 */
//--------------------------------------------------------
void DSEmulator::remove_dummyDynCmd_dynamic_command(string cmdname)
{
