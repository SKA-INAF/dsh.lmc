/*----- PROTECTED REGION ID(RxEmulator::DynAttrUtils.cpp) ENABLED START -----*/
static const char *RcsId = "$Id:  $";
//=============================================================================
//
// file :        RxEmulatorDynAttrUtils.cpp
//
// description : Dynamic attributes utilities file for the RxEmulator class
//
// project :     RxEmulator
//
...
/*----- PROTECTED REGION END -----*/	//	RxEmulator::DynAttrUtils.cpp
...
//	For compatibility reason, this file (RxEmulatorDynAttrUtils)
 ...
 */
//--------------------------------------------------------
void RxEmulator::add_dummyDynCmd_dynamic_command(string cmdname, bool device)
{
 ...
 */
//--------------------------------------------------------
void RxEmulator::remove_dummyDynCmd_dynamic_command(string cmdname)
{
