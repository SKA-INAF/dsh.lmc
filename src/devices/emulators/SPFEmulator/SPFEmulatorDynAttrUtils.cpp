/*----- PROTECTED REGION ID(SPFEmulator::DynAttrUtils.cpp) ENABLED START -----*/
static const char *RcsId = "$Id:  $";
//=============================================================================
//
// file :        SPFEmulatorDynAttrUtils.cpp
//
// description : Dynamic attributes utilities file for the SPFEmulator class
//
// project :     SPFEmulator
//
...
/*----- PROTECTED REGION END -----*/	//	SPFEmulator::DynAttrUtils.cpp
...
//	For compatibility reason, this file (SPFEmulatorDynAttrUtils)
 ...
 */
//--------------------------------------------------------
void SPFEmulator::add_dummyDynCmd_dynamic_command(string cmdname, bool device)
{
 ...
 */
//--------------------------------------------------------
void SPFEmulator::remove_dummyDynCmd_dynamic_command(string cmdname)
{
