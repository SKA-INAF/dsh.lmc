/*----- PROTECTED REGION ID(ElementLogger::DynAttrUtils.cpp) ENABLED START -----*/
//=============================================================================
//
// file :        ElementLoggerDynAttrUtils.cpp
//
// description : Dynamic attributes utilities file for the ElementLogger class
//
...
/*----- PROTECTED REGION END -----*/	//	ElementLogger::DynAttrUtils.cpp
...
//	For compatibility reason, this file (ElementLoggerDynAttrUtils)
 ...
 */
//--------------------------------------------------------
void ElementLogger::add_dummyDynCmd_dynamic_command(string cmdname, bool device)
{
 ...
 */
//--------------------------------------------------------
void ElementLogger::remove_dummyDynCmd_dynamic_command(string cmdname)
{
