/*----- PROTECTED REGION ID(LMCStarterClass.h) ENABLED START -----*/
//=============================================================================
//
// file :        LMCStarterClass.h
//
// description : Include for the LMCStarter root class.
//               This class is the singleton class for
//                the LMCStarter device class.
//               It contains all properties and methods which the 
//               LMCStarter requires only once e.g. the commands.
//
// project :     LMCManager
//
...
#ifndef LMCStarterClass_H
#define LMCStarterClass_H
...
/*----- PROTECTED REGION END -----*/	//	LMCStarterClass.h


namespace LMCStarter_ns
{
/*----- PROTECTED REGION ID(LMCStarterClass::classes for dynamic creation) ENABLED START -----*/


/*----- PROTECTED REGION END -----*/	//	LMCStarterClass::classes for dynamic creation
...
public:
	...
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<LMCStarter *>(dev))->read_NotifdState(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<LMCStarter *>(dev))->is_NotifdState_allowed(ty);}
};
...
public:
	...
	~HostStateAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<LMCStarter *>(dev))->read_HostState(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<LMCStarter *>(dev))->is_HostState_allowed(ty);}
};
...
public:
	...
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<LMCStarter *>(dev))->read_RunningServers(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<LMCStarter *>(dev))->is_RunningServers_allowed(ty);}
};
...
public:
	...
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<LMCStarter *>(dev))->read_StoppedServers(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<LMCStarter *>(dev))->is_StoppedServers_allowed(ty);}
};
...
public:
	...
	~ServersAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<LMCStarter *>(dev))->read_Servers(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<LMCStarter *>(dev))->is_Servers_allowed(ty);}
};
...
public:
	...
	{return (static_cast<LMCStarter *>(dev))->is_DevStart_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_DevStop_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_DevStartAll_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_DevStopAll_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_DevGetRunningServers_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_DevGetStopServers_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_DevReadLog_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_HardKillServer_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_NotifyDaemonState_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_ResetStatistics_allowed(any);}
};
...
public:
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_UpdateServersInfo_allowed(any);}
};
...
//=========================================
//	Command dummy_dyn_cmd class definition
class dummy_dyn_cmdClass : public Tango::Command
{
public:
	dummy_dyn_cmdClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LMCStarter *>(dev))->is_dummy_dyn_cmd_allowed(any);}
};


/**
 *	The LMCStarterClass singleton definition
 */

#ifdef _TG_WINDOWS_
class __declspec(dllexport)  LMCStarterClass : public LMCDevice_ns::LMCDeviceClass
#else
class LMCStarterClass : public LMCDevice_ns::LMCDeviceClass
#endif
{
	/*----- PROTECTED REGION ID(LMCStarterClass::Additionnal DServer data members) ENABLED START -----*/
	
	
	/*----- PROTECTED REGION END -----*/	//	LMCStarterClass::Additionnal DServer data members
	...
	public:
		...
		//	Method prototypes
		static LMCStarterClass *init(const char *);
		static LMCStarterClass *instance();
		~LMCStarterClass();
	...
	protected:
		LMCStarterClass(string &);
		static LMCStarterClass *_instance;
