...
class FileInfo {
	...
	public:
		...
		void Print(){
			...
			std::cout << "File WExt: "<<filename_wext<<std::endl;
			std::cout << "File Extension: "<< extension<<std::endl;
			std::cout << "File size (kB): "<<size/1024.<<std::endl;
			std::cout <<"***********************"<<std::endl;
		}
    ...
    static long long int getTimestamp_usec() {
      ...
      return std::chrono::duration_cast<std::chrono::microseconds>(duration).count();
		...
		static std::time_t TimeStringToUTCEpoch(std::string& stime) {
			...
			//std::cout<<"TimeStringToUTCEpoch(): utc_offset="<<utc_offset<<std::endl;
		...
		static std::time_t TimeStringToLocalEpoch(std::string& stime) {
			...
			//std::cout<<"TimeStringToLocalEpoch(): epoch_utc="<<epoch_utc<<", epoch_local="<<epoch_local<<std::endl;
			return epoch_local;
		}
		...
		//- Check file
		static int CheckFile(std::string path,Utils_ns::FileInfo& info,bool match_extension=false,std::string extension="");
